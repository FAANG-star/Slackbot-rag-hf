...
image = (
    ...
    .env({"IMAGE_VERSION": "93", "TORCHINDUCTOR_COMPILE_THREADS": "1", "VLLM_SERVER_DEV_MODE": "1", "TORCH_NCCL_ENABLE_MONITORING": "0"})  # bump BEFORE add_local_dir to invalidate code layers
